...
gulp.task('allTask', gulp.series(rbtFonts, rbtImage, html, vendorCss, pluginsCss, styleCss, scss, vendorJs, pluginsJs, mainJs));

/*-- Watch --*/
function watchFiles() {
    gulp.watch(src.fontsAll, gulp.series(rbtFonts, reload));
    gulp.watch(src.rootimage, gulp.series(rbtImage, reload));
