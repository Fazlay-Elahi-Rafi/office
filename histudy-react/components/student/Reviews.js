            ...
            <div className="rbt-dashboard-content bg-color-white rbt-shadow-box">
                <div className="content">
                    ...
                    <div className="tab-content">
                        <div className="tab-pane fade active show" id="received" role="tabpanel"
                                ...
                                <table className="rbt-table table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                            <span className="b3">Course: <a
                                                href="#">Speaking Korean for Beginners</a></span>
                                        ...
                                        <tr>
                                            ...
                                            <td>June 30, 2022</td>
                                            <td>
                                                <span className="b3">Course: <a href="#">PHP for Beginners</a></span>
                                                <div className="rbt-review">
                                                    <div className="rating">
                                                        <i className="fas fa-star"/>
                                                        <i className="fas fa-star"/>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span className="b3">Course: <a
                                                    href="#">WordPress for Beginners</a></span>
                                                <div className="rbt-review">
                                                    <div className="rating">
                                                        <i className="fas fa-star"/>
                                        ...
                                        <tr>
                                            ...
                                            <td>March 30, 2022</td>
                                            <td>
                                                <span className="b3">Course: <a href="#">Design for Beginners</a></span>
                                                <div className="rbt-review">
                                                    <div className="rating">
                                                        <i className="fas fa-star"/>
                                                        <i className="fas fa-star"/>
