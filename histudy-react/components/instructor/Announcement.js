            ...
            <div className="rbt-dashboard-content bg-color-white rbt-shadow-box">
                <div className="content">
                    <div className="section-title">
                        <h4 className="rbt-title-style-3">Announcements
                        </h4>
                    </div>
                            ...
                            <div className="row gy-5 align-items-end">
                                ...
                                <div className="col-lg-4">
                                    <div className="call-to-btn text-start text-lg-end position-relative">
                                        <a className="rbt-btn btn-sm rbt-switch-btn rbt-switch-y" href="#">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className="rbt-button-group justify-content-end">
                                            <a className="rbt-btn-link left-icon" href="#"><i
                                                className="feather-edit"></i> Edit</a>
                                            <a className="rbt-btn-link left-icon" href="#"><i
                                                className="feather-trash-2"></i> Delete</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
