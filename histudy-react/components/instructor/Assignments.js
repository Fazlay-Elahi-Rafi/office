                            ...
                            <tbody>
                                <tr>
                                    <th>
                                        ...
                                        <p className="b3">Course: <a href="#">Fundamentals 101</a></p>
                                    </th>
                                    <td>
                                        <p className="b3">80</p>
                                    </td>
                                    ...
                                    <td>
                                        <div className="rbt-button-group justify-content-end">
                                            <a className="rbt-btn btn-xs bg-primary-opacity radius-round" href="#"
                                               title="Edit"><i className="feather-edit pl--0"></i> Edit</a>
                                            <a className="rbt-btn btn-xs bg-color-danger-opacity radius-round color-danger"
                                               href="#" title="Delete"><i className="feather-trash-2 pl--0"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                        ...
                                        <p className="b3">Course: <a href="#">Speaking 101</a></p>
                                    </th>
                                    <td>
                                        <p className="b3">20</p>
                                    </td>
                                ...
                                <tr>
                                    <th>
                                        ...
                                        <p className="b3">Course: <a href="#">Song Writing</a></p>
                                    </th>
                                    <td>
                                        <p className="b3">60</p>
                                    </td>
                                ...
                                <tr>
                                    <th>
                                        ...
                                        <p className="b3">Course: <a href="#">Arabic Writing</a></p>
                                    </th>
                                    <td>
                                        <p className="b3">40</p>
                                    </td>
