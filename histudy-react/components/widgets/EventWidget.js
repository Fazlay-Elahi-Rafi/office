...
const EventWidget = ({event, widgetStyle = 'card'}) => {
    ...
    useEffect(() => {
        const getDateMonth = () => {
            ...
            setEventDateMonth(`${date.getDate()} ${date.toLocaleString('en-US', {month: 'short'})}`)
        }
        ...
        <>
                ...
                <div className="rbt-card event-grid-card variation-01 rbt-hover">
                    ...
                    <div className="rbt-card-body">
                        <ul className="rbt-meta">
                            <li>
                                <i className="feather-map-pin"/>{event.location}
                            </li>
                            <li>
                                <i className="feather-clock"/>{event.startTime} - {event.endTime}
                            </li>
                        </ul>
            ...
            {widgetStyle === 'list' && (
                <div className="rbt-card card-list-2 event-list-card variation-01 rbt-hover">
                    ...
                    <div className="rbt-card-body">
                        <ul className="rbt-meta">
                            <li><i className="feather-calendar"/>{event.startDate}</li>
                            <li><i className="feather-map-pin"/>{event.location}</li>
                        </ul>
                        ...
                        <div className="read-more-btn">
                            <a className="rbt-btn btn-border hover-icon-reverse btn-sm radius-round"
                               href={`/event/${event.id}`}>
                                <span className="icon-reverse-wrapper">
                                    <span className="btn-text">Get Ticket</span>
                                    <span className="btn-icon"><i className="feather-arrow-right"/></span>
